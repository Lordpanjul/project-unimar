<html>
<head>
    <title>Pendaftaran Calon Mahasiswa Baru Tahun Ajaran 2022/2023</title>
...
<form action="action-input-data.php" method="POST" name="pendaftaran">
    <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr height="46">
                <td width="10%"> </td>
                <td width="25%"> </td>
                <td width="65%"><font color="purple" size="2">Pendaftaran Calon Mahasiswa Baru Tahun Ajaran 2022/2023</font></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td>NIK</td>
            <td><input type="text" name="nik" size="35" maxlength="16" /></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td>Nama</td>
